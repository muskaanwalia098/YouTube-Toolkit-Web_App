...
def intro():
    ...
    **Interactive Video Chat** 💬🎬 - Dive deeper into the content of a YouTube video. This unique feature allows you to interactively chat with the video content, extracting insights and gaining a richer understanding.
...
def get_ques():
    ...
    """
    question = st.text_input("What would you like to know from the video? (Enter 'Thank You' to stop)", 
